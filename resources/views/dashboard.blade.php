                        ...
                        <tbody>
                            @foreach ($reports as $report)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('bookings.show', $report->id) }}"
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">
                        🔔 Today Check-ins
                        <span class="badge bg-primary ms-1">{{ $todayCheckIns->count() }}</span>
                    </h6>
                </div>

                <div class="card-body p-0">
                    @forelse ($todayCheckIns as $checkin)
                        <div class="checkin-item d-flex justify-content-between align-items-center">
                            <div>
                            ...
                            <div class="text-end">
                                <span class="checkin-time">
                                    {{ \Carbon\Carbon::parse($checkin->check_in_time)->format('h:i A') }}
                                </span>
                            </div>
                        </div>
                    @empty
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-0">
                    @forelse ($todayCheckOuts as $checkout)
                        <div class="checkin-item d-flex justify-content-between align-items-center">
                            <div>
                                <strong>{{ $checkout->guest_name }}</strong>
                                <div class="text-muted small">
                                    Room {{ $checkout->room->room_number }}
                                </div>
                            </div>

                            <div class="text-end">
                                <span class="checkout-time">
                                    {{ \Carbon\Carbon::parse($checkout->check_out)->format('h:i A') }}
                                </span>
                            </div>
                        </div>
                    @empty
